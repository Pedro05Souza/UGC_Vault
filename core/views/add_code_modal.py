...
class AddCodes(Modal, title="Add Codes"):
    def __init__(self, item_id: int, **kwargs):
        ...
        self.codes = TextInput (
            ...
            placeholder="Enter the codes here, separated by a comma.",
            required=True,
            max_length=400
        )
    ...
    async def on_submit(self, interaction: Interaction) -> None:
        try:
            ...
            await send_bot_embed(interaction, description="✅ The codes have been added successfully.", ephemeral=True)
